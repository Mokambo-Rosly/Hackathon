    ...
    <main className="w-full flex justify-center items-center">
      ...
      {!loading && planet && (
            ...
            <div className="w-full border-b-2 border-slate-900">
              <div className="relative">
                <img
                  ...
                  src={planet.display_name === "LysGan" ? "https://media.discordapp.net/attachments/1124002659112845345/1160542565947412581/MonLysGan.png?ex=65350a7d&is=6522957d&hm=54d41b731be33da5fb68f007d87a134143ab454121850a606c7beeafd7c26af1&=&width=751&height=422" : "https://exoplanets.nasa.gov" + planet.image}
                  alt="blog"
                />
        ...
        text-5xl md:text-6xl lg:text-7xl xl:text-8xl 2xl:text-8xl mt-44"
          ...
          <div className="bg-black h-full w-full py-8 bg-opacity-50 pl-[7.5em]">
            <div className="mb-14">
              <article
...
const PlanetTable = (props) => {
  ...
  return (
    <Table className="w-full bg-black">
      <Table.Head>
        <Table.HeadCell className="text-white">Caractéristiques de la planète</Table.HeadCell>
        <Table.HeadCell className="text-white">Valeur</Table.HeadCell>
      </Table.Head>
