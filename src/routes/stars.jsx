      ...
      <div className="p-6 bg-black rounded-bl-lg rounded-br-lg flex-auto ">
        ...
        <h2 className="leading-relaxed mb-4 text-slate-400 italic text-lg md:text-xl lg:text-2xl">
          {props.star.planets.length > 1
            ? `${props.star.planets.length}  planètes orbitent`
            : `${props.star.planets.length}  planète orbite`}{" "}
           autour d'une étoile de type {props.star.starType},{" "}
          <span className="text-yellow-400">située à {" "}
        ...
        <div className="flex items-center justify-between">
          ...
          >
            ...
            <span className="sm:text-md md:text-md lg:text-lg">Visiter l'étoile</span>
          </Button>
          <div>
            <span
